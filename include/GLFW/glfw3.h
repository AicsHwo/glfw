 ...
 *
 *  This is the reference documentation for clipboard related functions.  For more
 *  information, see the @ref input.
 */
 ...
 *
 *  This is the reference documentation for error related functions.  For more
 *  information, see the @ref intro.
 */
 ...
 *
 *  This is the reference documentation for time related functions.  For more
 *  information, see the @ref input.
 */
 ...
 *  [make it current](@ref context_current).
 *
 ...
 *
 *  This function returns the values of all axes of the specified joystick.  The
 *  returned array is allocated and freed by GLFW.  You should not free it
 *  yourself.
 *
 *  @param[in] joy The [joystick](@ref joysticks) to query.
 *  @param[out] count Where to store the size of the returned array.  This is
