                                     ...
                                     GLFWwindow* share)
{
    ...
    fbconfig.alphaMask  = _glfw.hints.framebuffer.alphaMask ? GL_TRUE : GL_FALSE;
    ...
    wndconfig.alphaMask = _glfw.hints.framebuffer.alphaMask ? GL_TRUE : GL_FALSE;
...
void glfwDefaultWindowHints(void)
{
	...
	_glfw.hints.framebuffer.alphaMask    = GL_FALSE;
